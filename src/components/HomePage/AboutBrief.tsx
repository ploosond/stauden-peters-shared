const AboutBrief = () => {
  return (
    <>
      <div className="padding flex flex-col lg:flex-row gap-6 py-12 md:py-16 lg:py-24 text-center lg:text-left">
        {/* left side */}
        <div className="lg:w-1/2">
          ...
          <p className="flex-wrap text-muted-foreground text-sm xl:text-base leading-7">
          ...
          <br />
          <p className="hidden lg:flex flex-wrap text-muted-foreground text-sm  leading-7 xl:text-base">
        ...
        {/* right side */}
        <div className="flex lg:w-1/2 flex-col sm:flex-row">
          <img
            className="w-full min-h-96 rounded-xl object-cover xl:object-left-bottom"
            src="/about-brief.jpg"
            alt="photo"
          />
        </div>
